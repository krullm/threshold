...
#### Description
# Generic function to generate no observed effect concentration (NEC) datasets 
...
# A non-linear model with a threshold parameter was modified from Pires et al. (2002), 
